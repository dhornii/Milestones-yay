...
from py_pubsub.FK_for_RViz2 import IK_3dofspec_loky
...
class IK_listener(Node):
    ...
    def tf_callback(self):
        ...
        try:
            ...
            hasil_ik = IK_3dofspec_loky(x, y, z, 3 / 6)
            ...
            self.get_logger().info(f'Pasangan solusi sudut: [{th_c:.4f}, {th_f:.4f}, {th_t:.4f}]')
